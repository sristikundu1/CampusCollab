  ...
  new Schema(
    {
      ...
      normalizedName: { ...textField({ required: true, min: 2, max: 160 }), lowercase: true },
      ...
      status: { type: String, enum: ['PROPOSED', 'ACTIVE', 'INACTIVE'], default: 'PROPOSED', required: true },
...
universitySchema.index({ normalizedName: 1, countryCode: 1 }, { unique: true, name: 'uq_universities_name_country' });
