...
export function targetProposalState(current, action) {
  ...
  if(!transition||!transition.from.includes(current)) throw new ConflictError('INVALID_STATE','This proposal lifecycle transition is not allowed.');
  return transition.to;
}

export const editableProposalStates=Object.freeze(['SUBMITTED','SHORTLISTED']);
