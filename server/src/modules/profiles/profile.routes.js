...
export function createProfileRouter(dependencies) {
  ...
  router.get(
    "/profiles/me",
    auth.authenticate,
    validateRequest(ownProfileRequest),
    controller.own,
  );
  router.post(
    "/profiles/me",
  ...
  router.patch(
    ...
    auth.authenticate,
    auth.requireCsrf,
    validateRequest(updateProfileRequest),
    controller.update,
  );
  router.put(
    "/profiles/me/skills",
    auth.authenticate,
    auth.requireCsrf,
    validateRequest(replaceSkillsRequest),
    controller.skills,
  );
  router.patch(
    ...
    auth.authenticate,
    auth.requireCsrf,
    validateRequest(availabilityRequest),
    controller.availability,
  );
  router.get(
    "/profiles/me/portfolio-items",
    auth.authenticate,
    validateRequest(portfolioListRequest),
    controller.ownPortfolio,
  );
  router.post(
    "/profiles/me/portfolio-items",
    auth.authenticate,
  ...
  router.get(
    ...
    validateRequest(publicProfileRequest),
    controller.public,
  );
  router.get(
    "/profiles/:userId/portfolio-items",
    auth.optionalAuthenticate,
    validateRequest(publicPortfolioListRequest),
    controller.publicPortfolio,
  );
  router.get(
    "/portfolio-items/:itemId",
    auth.optionalAuthenticate,
    validateRequest(portfolioItemRequest),
