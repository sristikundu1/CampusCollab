  ...
  return {
    own: async (request, response) =>
      respond(response, request, {
        profile: await profileService.own(userId(request)),
      }),
    public: async (request, response) =>
      respond(response, request, {
        profile: await profileService.publicProfile(
    ...
    skills: async (request, response) =>
      respond(response, request, {
        profile: await profileService.replaceSkills(
          userId(request),
    ...
    availability: async (request, response) =>
      respond(response, request, {
        profile: await profileService.updateAvailability(
          userId(request),
          request.validated.body,
        ),
      }),
    ownPortfolio: async (request, response) =>
      respond(response, request, {
        items: await profileService.listOwnPortfolio(
          userId(request),
          request.validated.query.status,
        ),
      }),
    publicPortfolio: async (request, response) =>
      respond(response, request, {
        items: await profileService.publicPortfolio(
          request.validated.params.userId,
          request.auth?.user?._id,
        ),
      }),
    createPortfolio: async (request, response) =>
      respond(
        ...
        request,
        {
          item: await profileService.createPortfolio(
            userId(request),
            request.validated.body,
          ),
        },
    ...
    getPortfolio: async (request, response) =>
      respond(response, request, {
        item: await profileService.getPortfolio(
    ...
    updatePortfolio: async (request, response) =>
      respond(response, request, {
        item: await profileService.updatePortfolio(
          userId(request),
          request.validated.params.itemId,
          request.validated.body,
        ),
    ...
    deletePortfolio: async (request, response) => {
      await profileService.deletePortfolio(
        userId(request),
        request.validated.params.itemId,
      );
