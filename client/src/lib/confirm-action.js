...
export async function confirmAction({ title, text, confirmText = 'Confirm', icon = 'question', danger = false }) {
...
export async function showLoginRequired() {
  ...
  return Swal.fire({
    ...
    buttonsStyling: false,
    customClass: { popup: 'campus-swal-popup', title: 'campus-swal-title', htmlContainer: 'campus-swal-copy', confirmButton: 'campus-swal-confirm' },
  });
}
