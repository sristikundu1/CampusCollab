      ...
      <div>
        <div className="flex flex-wrap items-end justify-between gap-4">
          <div>
            ...
            <h1 className="mt-2 text-3xl font-black">My Projects</h1>
        ...
        {error ? (
          ...
          <div className="surface mt-7 p-10 text-center">
            <h2 className="text-xl font-black">No projects in this view</h2>
            <p className="mt-2 text-slate-600">
              Create a project or discover a team to join.
            </p>
