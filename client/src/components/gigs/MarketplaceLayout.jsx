      ...
      <header className="border-b border-slate-200 bg-white">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between gap-2 px-3 sm:px-6">
          ...
          <div className="flex shrink-0 gap-1.5 sm:gap-2">
            <Link
              className="btn-secondary whitespace-nowrap px-3 py-2 text-xs sm:px-5 sm:py-3 sm:text-sm"
              to="/login"
            >
              Sign in
            </Link>
            <Link
              className="btn-primary whitespace-nowrap px-3 py-2 text-xs sm:px-5 sm:py-3 sm:text-sm"
              to="/register"
            >
              <span className="sm:hidden">Join</span>
              <span className="hidden sm:inline">Join CampusCollab</span>
            </Link>
          </div>
        </div>
      </header>
